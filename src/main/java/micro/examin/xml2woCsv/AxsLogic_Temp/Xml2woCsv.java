...
//    private static String currProduct = "";
//    private static String excelFilePath = "";
//
//    public static void main(String[] args) throws IOException, XMLStreamException, XPathExpressionException {
//        String model = ("/home/gaurav/Downloads/Model");
//        String output = "/home/gaurav/Downloads/Final Model Output/";
//        File modelFolder = new File(model);
//        if (modelFolder.isDirectory()) {
//            for (File productFolder : modelFolder.listFiles()) {
//                currProduct = productFolder.getName();
//                File esServiceOutputFolder =  new File(output+currProduct);
//                if(!Files.exists(Paths.get(output+currProduct))) {
//                    boolean created = esServiceOutputFolder.mkdirs();
//                    if(created==false){
//                        // System.out.println("unable to create file at path "+esServiceOutputFolder.getPath());
//                        System.exit(0);
//
//                    }
//                }
//                for (File subProductData : productFolder.listFiles()) {
//                    excelFilePath = output+currProduct+"allMeasure.xlsx";
//                    File xmlFilePath = subProductData;
...
//        }
//
//        usingDirectResolve1(derivedMeasureFolder, allNameMeasureFolder);
//
...
//    }
//
//    private static void usingDirectResolve1(MeasureFolder derivedMeasureFolder, MeasureFolder allNameMeasureFolder) {
...
////			}
////		}
//		resolveDerivedRef(allName, derived,DIRECT);
//
...
//    }
//
//    private static void resolveDerivedRef(HashMap<String, String> allName, HashMap<String, String> derived, HashMap<String, String> DIRECT) {
//        Set<String> itr = new HashSet<>(allName.keySet());
//        String regex = "\\[(.*?)\\]";
//        Pattern derivedPattern = Pattern.compile(regex, Pattern.MULTILINE);
//        for (String curr : itr) {
//            String measureName = curr;
//            String measureQuery = allName.get(curr);
//            Matcher matcher = derivedPattern.matcher(measureQuery);
//            HashSet<String> thisMeasureUseMeasures = new HashSet<>();
//            boolean anyChange = false;
//            while (matcher.find()) {
//                System.out.printf("");
//                for (int i = 1; i <= matcher.groupCount(); i++) {
//                    thisMeasureUseMeasures.add(matcher.group(i));
//                }
//            }
//            for (String usedMeasure : thisMeasureUseMeasures) {
//				resolveMeasureAndGetPutInDerived(derived, usedMeasure);
//				measureQuery = measureQuery.replace("[" + usedMeasure + "]", derived.get(usedMeasure));
//                anyChange = true;
//            }
//            if (anyChange) {
//                allName.put(curr, measureQuery);
//                // System.out.println(measureName+" =>  "+measureQuery);
//                DIRECT.put(curr, measureQuery);
//            }
//        }
//    }
//
//    private static void resolveMeasureAndGetPutInDerived(HashMap<String, String> derived, String currMeasureName) {
//        String regex = "\\[(.*?)\\]";
//        Pattern derivedPattern = Pattern.compile(regex, Pattern.MULTILINE);
//        String measureName = currMeasureName;
//        String measureQuery = derived.get(currMeasureName);
//        Matcher matcher = derivedPattern.matcher(measureQuery);
//        HashSet<String> thisMeasureUseMeasures = new HashSet<>();
//
//        boolean anyChangeRequired = false;
//        while (matcher.find()) {
//            System.out.printf("");
//            for (int i = 1; i <= matcher.groupCount(); i++) {
//                thisMeasureUseMeasures.add(matcher.group(i));
...
//			resolveMeasureAndGetPutInDerived(derived, usedMeasure);
//            measureQuery = measureQuery.replace("[" + usedMeasure + "]", derived.get(usedMeasure));
//            anyChangeRequired = true;
//        }
//        if (anyChangeRequired) {
//            derived.put(currMeasureName, measureQuery);
//        }
//
//    }
//
...
//
//        String excelFileName = excelFilePath;
...
//        String excelFileName = "/home/gaurav/Music/Axslogic_SNF_WORK_Utils/"+currProduct+" Measure/MicroV7.xlsx";
//        File file = new File(excelFileName);
